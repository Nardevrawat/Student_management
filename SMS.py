...
label = Label(root, text="Student Management System",
              font=('Arial Bold', 45))
label.grid(row=0, column=0, columnspan=8, padx=50, pady=40)
...
addBtn = Button(
    root, text="Add", padx=65, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#84F894", command=add)
updateBtn = Button(
    root, text="Update", padx=65, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#84E8F8", command=update)
deleteBtn = Button(
    root, text="Delete", padx=65, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#FF9999", command=delete)
searchBtn = Button(
    root, text="Search", padx=65, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#F4FE82", command=search)
resetBtn = Button(
    root, text="Reset", padx=65, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#F398FF", command=reset)
selectBtn = Button(
    root, text="Select", padx=65, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#EEEEEE", command=select)
clearBtn = Button(
    root, text="Clear", padx=65, pady=15, width=10,
    bd=5, font=('Arial', 15), bg="#EEEEEE", command=clear_text)
...
clearBtn.grid(row=15, column=5, columnspan=1, rowspan=2)
